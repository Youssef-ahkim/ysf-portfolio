...
export default function About() {
    return (
        <section className="hero-section flex flex-col justify-center items-start min-h-[60vh] px-4 sm:px-8 lg:px-16 z-1">
            <div className="about-text max-w-full sm:max-w-[80%] lg:max-w-[50%] bg-gradient-to-br from-blue-800 via-blue-900 to-gray-800 text-white border border-white/30 p-6 rounded-2xl shadow-xl transition-transform duration-300 transform hover:scale-105 hover:shadow-2xl backdrop-blur-lg">
